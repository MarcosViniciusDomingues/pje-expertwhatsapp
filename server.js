...
const FALLBACK_MSG =
  ...
  'ou pelos telefones (81) 3425-9241 ou (81) 3425-9920 — atendimento de segunda a sexta, ' +
  'das 8h às 18h. Antes de acionar o suporte humano, certifique-se de ter anotado o ' +
  'número do processo e o print da tela do erro. Estou à disposição para ajudar em caso ' +
  'de dúvidas!';
...
// ── Mesma função de matching usada no protótipo web ────────
...
function getAnswer(message) {
  ...
  for (const qa of staticQA) {
    const matched = qa.patterns.some(p => lower.includes(normaliza(p)));
